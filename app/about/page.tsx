...
export const metadata: Metadata = {
  ...
  description:
    "Discover PROJXON’s mission, values, and expertise in business consulting. We help companies achieve growth through strategic insights and innovation.",
          ...
          <Row className="align-items-center g-5">
            ...
            >
              ...
              <div className="mt-3 who-we-are-description gray-opacity">
                <p className="fs-5">
                  We specialize in transforming operational chaos into clarity
                  through strategic planning, process improvement, and project
                  execution. From streamlining systems to guiding high-stakes
                  growth, we deliver tailored solutions that empower our clients
                  to lead, innovate, and thrive.
                </p>
                <p className="fs-5 mb-4 pb-2">
                  Our cross-functional team brings deep industry expertise and a
                  relentless focus on results, because your mission deserves
                  more than just advice. It deserves momentum.
                </p>
              </div>
          ...
          <Row className="g-5">
            ...
            >
              <section className="w-100">
                <h2 className="fs-1 mb-4 text-uppercase fw-bold">Mission</h2>
                <p className="fs-5">
