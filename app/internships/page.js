        ...
        <Container id="mip" className="momentum-intern sections-container">
          <Row className="align-items-center flex-row-reverse g-5">
            <Col xs={12} data-aos="fade-right">
              ...
              <p>
                Welcome to <strong>PROJXON</strong> where bold thinkers become high-impact professionals.
              </p>
              <p>
              ...
              <p>
                At PROJXON, we’ve redefined internships from the ground up.<br />
                This <strong>Participant-First</strong> program centers on your vocational, professional, and career development, not busy work. You’ll collaborate on real projects, work with experienced leaders, and gain unmatched hands-on experience in a high-performance consulting environment.
              </p>
